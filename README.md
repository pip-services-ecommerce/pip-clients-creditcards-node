...
This is a Node.js client SDK for [pip-services-creditcards](https://github.com/pip-services/pip-services-creditcards) microservice.
...
```javascript
{
    ...
    "dependencies": {
        ....
        "pip-clients-creditcards-node": "^2.0.*",
        ...
    }
}
```
